		...
		try {
			...
			case 6:
				return static_cast<IImGuiVRHelperInterface006*>(
					&ImGuiVRHelper::HelperImpl::GetSingleton());
			case 7:
				return static_cast<IImGuiVRHelperInterface007*>(
					&ImGuiVRHelper::HelperImpl::GetSingleton());
			case 8:
				return static_cast<IImGuiVRHelperInterface008*>(
					&ImGuiVRHelper::HelperImpl::GetSingleton());
			case 9:
				return static_cast<IImGuiVRHelperInterface009*>(
					&ImGuiVRHelper::HelperImpl::GetSingleton());
			case 10:
				return static_cast<IImGuiVRHelperInterface010*>(
					&ImGuiVRHelper::HelperImpl::GetSingleton());
			default:
