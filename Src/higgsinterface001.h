...
namespace HiggsPluginAPI {
    ...
    IHiggsInterface001 * GetHiggsInterface001(SKSE::PluginHandle pluginHandle, const SKSE::MessagingInterface* messagingInterface);
    ...
    struct IHiggsInterface001
    {
        ...
        virtual bool CanGrabObject(RE::TESObjectREFR *object, bool isLeft) = 0;
