...
namespace dragonboard::ui::rml
{
    ...
    public:
        ...
        [[nodiscard]] std::optional<Entry> Select(std::size_t magicIndex);
        [[nodiscard]] std::uint32_t FormIDAt(std::size_t magicIndex) const;
        void Sync(DragonBoardRmlUi& rmlUi, bool editModeEnabled);
