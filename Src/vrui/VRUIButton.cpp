    ...
    void VRUIButton::releaseGrab()
    {
        ...
        if (_node) {
            ...
            if (buttonId == "Status") {
                ...
                settings.bPrevPosX = _node->local.translate.x; settings.bPrevPosY = _node->local.translate.y; settings.bPrevPosZ = _node->local.translate.z;
                settings.bPrevRotX = rx; settings.bPrevRotY = ry; settings.bPrevRotZ = rz;
                settings.bPrevScale = _node->local.scale;
                ...
                settings.bNextPosX = _node->local.translate.x; settings.bNextPosY = _node->local.translate.y; settings.bNextPosZ = _node->local.translate.z;
                settings.bNextRotX = rx; settings.bNextRotY = ry; settings.bNextRotZ = rz;
                settings.bNextScale = _node->local.scale;
